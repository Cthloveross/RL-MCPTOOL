#!/bin/bash
#SBATCH --job-name=qwen3-def-think
...
#SBATCH --output=slurm/logs/qwen3_defense_%j.out
#SBATCH --error=slurm/logs/qwen3_defense_%j.err

echo "Qwen3-8B defense eval (Think) — $(date)"
echo "Node: $(hostname)"
...
python scripts/qwen3_defense_eval.py --max-new-tokens 2048
