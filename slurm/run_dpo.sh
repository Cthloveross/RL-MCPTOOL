...
#SBATCH --output=slurm/logs/dpo_%j.out
#SBATCH --error=slurm/logs/dpo_%j.err

echo "MCPDefender DPO Training — $(date)"
echo "Node: $(hostname)"
...
python -u scripts/mcpalign_train_dpo.py \
